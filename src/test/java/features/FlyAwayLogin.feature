Feature: This feature file will validate login to flyaway application
  ...
  Scenario Outline: Validate successful login to flyaway application
    ...
    Then I should be sccessfully login to application and should be on dashboard page "<SuccessfulMessage>"

    Examples: 
      | EmailId      | Password  | SuccessfulMessage   |
      | abcd@xyz.com | Admin@123 | FLYAWAY - DASHBOARD |
